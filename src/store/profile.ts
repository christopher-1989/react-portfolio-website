export const profile = {
  ...
  about: "I am a driven, hard working, creative and personable individual currently employed as a permanent full-time Software Engineer at Insignia Financial.",
  ...
  competencies: [
    "Develop and maintain features for both front end (React/TS) and back end (Micro services and REST APIs) technologies.",
    "Discover and develop production support solutions for various problems using a various Full-stack Technologies.",
    "Contribute, plan and facilitate meetings with users and developers.",
    "Participate in and deliver team meetings adoption of new technologies.",
    "Review user requests and discuss possible solutions that is supported by data.",
    "Create and update domain knowledge and business logic using tools such as Miro or within documentation.",
    "Monitor, investigate, evaluate active and new micro services.",
    "Follow established CI/CD best practices.",
  ...
  contactPageMessage: "To contact me please send a message on LinkedIn or comment on GitHub"
}
